...
! return value -> llf (log-likelihood)
  ...
  subroutine gph_estep_group_unif_dense(n, alpha, baralpha, tau, ev, &
    ...
    deallocate(poi)
  end subroutine gph_estep_group_unif_dense

  subroutine gph_estep_group_unif_csr(n, alpha, baralpha, tau, ev, &
    ...
    deallocate(poi)
  end subroutine gph_estep_group_unif_csr

  subroutine gph_estep_group_unif_csc(n, alpha, baralpha, tau, ev, &
    ...
    deallocate(poi)
  end subroutine gph_estep_group_unif_csc

  subroutine gph_estep_group_unif_coo(n, alpha, baralpha, tau, ev, &
    ...
    deallocate(poi)
  end subroutine gph_estep_group_unif_coo

end module gph_estep_group
